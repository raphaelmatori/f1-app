...
let RaceItemStubComponent = class RaceItemStubComponent {
    race;
...
__decorate([
    Input()
], RaceItemStubComponent.prototype, "race", void 0);
__decorate([
    Input()
], RaceItemStubComponent.prototype, "isCurrentSeason", void 0);
__decorate([
    Input()
], RaceItemStubComponent.prototype, "isChampionWinner", void 0);
RaceItemStubComponent = __decorate([
    Component({
        selector: 'app-race-item',
        template: '<div class="race-item-stub">Race Item Stub</div>',
        standalone: true
    })
], RaceItemStubComponent);
describe('RaceListComponent', () => {
    ...
    it('should display race items when races are available', () => {
        ...
        const raceItem = raceItems[0].componentInstance;
    ...
    it('should return false for isChampionWinner when winner IDs dont match', () => {
        const differentDriver = { ...mockDriver, driverId: 'different_id' };
